...
*/
EXPAND io(0x77);  		//initialize an instance of the class with address 0x01
...
void loop()
{
io.digitalWrite(19, LOW);
io.digitalWrite(20, HIGH);
io.digitalWrite(18, HIGH);
delay(500);
io.digitalWrite(19, HIGH);
io.digitalWrite(18, LOW);
io.digitalWrite(20, HIGH);
delay(500);
io.digitalWrite(19, HIGH);
io.digitalWrite(18, HIGH);
io.digitalWrite(20, LOW);
delay(500);
}
